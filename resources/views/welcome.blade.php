            ...
            <div class="text-white space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-3xl font-semibold text-gray-200">
                        Smart School Financial Management System
                    </p>
                ...
                <div class="space-y-4 pt-8">
                    ...
                    <div class="flex items-center space-x-4 bg-white/5 backdrop-blur-lg rounded-xl p-4 border border-white/10">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-400">
                                Kelola pembayaran siswa secara real-time.
                            </p>
                        </div>
                    ...
                    <div class="flex items-center space-x-4 bg-white/5 backdrop-blur-lg rounded-xl p-4 border border-white/10">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-400">
                                Dashboard dan laporan keuangan detail.
                            </p>
                        </div>
                    ...
                    <div class="flex items-center space-x-4 bg-white/5 backdrop-blur-lg rounded-xl p-4 border border-white/10">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-400">
                                Admin, Bendahara, TU, Kepala Sekolah.
                            </p>
                        </div>
            ...
            <div class="bg-white/10 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
                ...
                <div class="space-y-4">
                    ...
                    @else
                        ...
                        <!-- Login -->
                        <a href="{{ route('login') }}"
                           class="group relative w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold py-4 px-6 rounded-xl text-center transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                        ...
                        <a href="{{ route('developer') }}"
                           class="block w-full bg-white/10 hover:bg-white/20 text-white font-semibold py-4 px-6 rounded-xl text-center border-2 border-white/30 hover:border-white/50 transition-all duration-300">

                            <span class="text-lg">Developer Profile</span>
