<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Pemasukan</h2>
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <form action="{{ route('admin.pemasukan.store') }}" method="POST" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="kategori" id="kategori" value="{{ old('kategori') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Contoh: Donasi, Hibah, dll">
                    </div>
