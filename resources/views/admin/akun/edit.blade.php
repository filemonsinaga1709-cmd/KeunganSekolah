            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <div class="px-6 py-4 bg-gradient-to-r from-yellow-500 to-yellow-600 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-white flex items-center">
                        ...
                        Form Edit Akun: {{ $akun->kode_akun }}
                    </h3>
                </div>

                <form action="{{ route('admin.akun.update', $akun) }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" 
                               ...
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500 font-mono @error('kode_akun') border-red-500 @enderror"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" 
                               ...
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500 @error('nama_akun') border-red-500 @enderror"
                    ...
                    <div class="mb-6">
                        ...
                        <select name="tipe_akun" 
                                id="tipe_akun" 
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500 @error('tipe_akun') border-red-500 @enderror"
                                required>
                            <option value="">-- Pilih Tipe Akun --</option>
                            <option value="aset" {{ old('tipe_akun', $akun->tipe_akun) == 'aset' ? 'selected' : '' }}>Aset</option>
                            <option value="kewajiban" {{ old('tipe_akun', $akun->tipe_akun) == 'kewajiban' ? 'selected' : '' }}>Kewajiban</option>
                            <option value="modal" {{ old('tipe_akun', $akun->tipe_akun) == 'modal' ? 'selected' : '' }}>Modal</option>
                    ...
                    <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                        ...
                        <button type="submit" class="inline-flex items-center px-6 py-2 bg-yellow-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-yellow-600 focus:outline-none transition">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
